# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-07-23 01:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('style', models.CharField(max_length=64, verbose_name='办学类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_node', models.CharField(default=0, max_length=5, verbose_name='父节点')),
                ('description', models.TextField(default=None, verbose_name='备注')),
                ('create_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='创建日期')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新日期')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default=None, verbose_name='备注')),
                ('established', models.DateTimeField(default=None, verbose_name='公司成立时间')),
                ('create_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='创建日期')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(default=django.utils.timezone.now, verbose_name='创建日期')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新日期')),
                ('academic_requirements', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='academic_requirements_job', to='huntjob.Academic_Requirements')),
